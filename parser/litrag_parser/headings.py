...
CANON: dict[str, tuple[str, tuple[str, ...]]] = {
    ...
    "Highlights": ("other", ("highlights", "key points", "key messages", "significance statement", "summary points", "lay summary", "plain language summary", "significance", "research in context", "what this paper adds", "key findings", "impact statement", "statement of significance", "novelty statement", "key message", "main points", "highlight", "what is already known", "what this study adds", "article highlights", "practitioner points", "new and noteworthy")),
